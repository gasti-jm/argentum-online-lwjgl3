...
public class ChangeDescriptionCommand extends BaseCommandHandler {
    ...
    public void handle(TextContext textContext) throws CommandException {
        requireArguments(textContext, -1, "/desc <description>"); // TODO Podria verificarse en el proceso de comandos ya que la mayoria de comandos tiene argumentos
        ...
        writeChangeDescription(textContext.argumentsRaw());
    }
