...
import static org.aoclient.network.protocol.Protocol.createTeleport;
import static org.aoclient.network.protocol.command.metadata.GameCommand.CREATE_TELEPORT;

public class CreateTeleportCommand extends BaseCommandHandler {
