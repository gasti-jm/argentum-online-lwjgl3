...
import static org.aoclient.network.protocol.Protocol.modPlayer;
...
public class ModPlayerCommand extends BaseCommandHandler {
    ...
    public void handle(CommandContext commandContext) throws CommandException {
        ...
        else modPlayer(player, editType.getValue(), value, extraParam);
    }
