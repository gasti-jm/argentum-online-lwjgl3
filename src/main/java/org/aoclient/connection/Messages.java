...
public class Messages {
    ...
    public static final String MENSAJE_USUARIO_RECHAZO_ATAQUE_ESCUDO  = "¡¡¡El usuario rechazó el ataque con su escudo!!!";
    public static final String MENSAJE_FALLADO_GOLPE = "¡¡¡Has fallado el golpe!!!";
    public static final String MENSAJE_SEGURO_ACTIVADO = ">>SEGURO ACTIVADO<<";
    public static final String MENSAJE_SEGURO_DESACTIVADO = ">>SEGURO DESACTIVADO<<";
    public static final String MENSAJE_PIERDE_NOBLEZA = "¡¡Has perdido puntaje de nobleza y ganado puntaje de criminalidad!! Si sigues ayudando a criminales te convertirás en uno de ellos y serás perseguido por las tropas de las ciudades.";
    public static final String MENSAJE_USAR_MEDITANDO = "¡Estás meditando! Debes dejar de meditar para usar objetos.";
    ...
    public static final String MENSAJE_GOLPE_CABEZA = "¡¡La criatura te ha pegado en la cabeza por ";
    public static final String MENSAJE_GOLPE_BRAZO_IZQ = "¡¡La criatura te ha pegado el brazo izquierdo por ";
    public static final String MENSAJE_GOLPE_BRAZO_DER = "¡¡La criatura te ha pegado el brazo derecho por ";
    public static final String MENSAJE_GOLPE_PIERNA_IZQ = "¡¡La criatura te ha pegado la pierna izquierda por ";
    public static final String MENSAJE_GOLPE_PIERNA_DER = "¡¡La criatura te ha pegado la pierna derecha por ";
    public static final String MENSAJE_GOLPE_TORSO  = "¡¡La criatura te ha pegado en el torso por ";

    // MENSAJE_[12]: Aparecen antes y despues del valor de los mensajes anteriores (MENSAJE_GOLPE_*)
    public static final String MENSAJE_1 = "¡¡";
    public static final String MENSAJE_2 = "!!";
    public static final String MENSAJE_11 = "¡";
    public static final String MENSAJE_22 = "!";

    public static final String MENSAJE_GOLPE_CRIATURA_1 = "¡¡Le has pegado a la criatura por ";

    public static final String MENSAJE_ATAQUE_FALLO = " te atacó y falló!!";
    ...
    public static final String MENSAJE_PRODUCE_IMPACTO_1 = "¡¡Le has pegado a ";
    ...
    public static final String MENSAJE_TRABAJO_ROBAR = "Haz click sobre la víctima...";
    public static final String MENSAJE_TRABAJO_TALAR = "Haz click sobre el árbol...";
    ...
    public static final String MENSAJE_TRABAJO_PROYECTILES = "Haz click sobre la victima...";
    ...
    public static final String MENSAJE_FRAGSHOOTER_TE_HA_MATADO = "te ha matado!";
    ...
    public static final String MENSAJE_TE_HA_MATADO = " te ha matado!";
